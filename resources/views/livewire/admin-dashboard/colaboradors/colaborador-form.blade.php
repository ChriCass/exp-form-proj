        ...
        <form wire:submit.prevent="submit" enctype="multipart/form-data">
            ...
            <div class="body">
                ...
                <div class="row clearfix">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <select id="codigo_tdoc" class="form-control @error('codigo_tdoc') is-invalid @enderror" wire:model="codigo_tdoc">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input id="numerodoc_col" type="text" class="form-control @error('numerodoc_col') is-invalid @enderror" wire:model="numerodoc_col">
                            @error('numerodoc_col')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                ...
                <div class="row clearfix">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input id="apellidopaterno_col" type="text" class="form-control @error('apellidopaterno_col') is-invalid @enderror" wire:model="apellidopaterno_col">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input id="apellidomaterno_col" type="text" class="form-control @error('apellidomaterno_col') is-invalid @enderror" wire:model="apellidomaterno_col">
                ...
                <div class="row clearfix">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input id="nombres_col" type="text" class="form-control @error('nombres_col') is-invalid @enderror" wire:model="nombres_col">
                            @error('nombres_col')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                ...
                <div class="col-lg-12 p-t-20 text-center">
                    ...
                    <a href="{{ route('colaboradors.index') }}" class="btn btn-danger waves-effect">Cancel</a>
                </div>
            </div>
        </form>
    </div>
