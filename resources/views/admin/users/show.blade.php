        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="card">
                    <div class="header">
                        <h2>
                            <strong>Detalles</strong> del Usuario
                        </h2>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <p><strong>Colaborador:</strong>
                                    {{ $user->colaborador->apellidopaterno_col ?? 'N/A' }}
                                    {{ $user->colaborador->apellidomaterno_col ?? 'N/A' }}
                                    {{ $user->colaborador->nombres_col ?? 'N/A' }}
                                </p>
                                <p><strong>Rol:</strong> {{ $user->rol->nombre_rol }}</p>
                                <p><strong>Estado:</strong> {{ $user->estado_usu ? 'Activo' : 'Inactivo' }}</p>
                            </div>
